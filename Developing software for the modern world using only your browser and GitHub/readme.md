# [Demo] Developing software for the modern world using only your browser and GitHub

## References

Some of the links were used partially to create the content and others are just for reference purposes
...
- [Authenticate with Azure Container Registry from Azure Kubernetes Service](https://docs.microsoft.com/en-us/azure/aks/cluster-container-registry-integration)
